...
public class Ex01 {
    ...
    public static final String SONG_PATH = "src/sec12/ch04/beatles.txt";

    public static void main(String[] args) {
        var frw = measureTime(Ex01::fileReaderWriterEx);
        var brw = measureTime(Ex01::bufferedReaderWriterEx);

        String frw2 = measureTime(Ex01::fileReaderWriterEx);
        String brw2 = measureTime(Ex01::bufferedReaderWriterEx);
